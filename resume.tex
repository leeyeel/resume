...
\datedsubsection{\textbf{Dahua Technology} \quad \textit{Embedded Linux Software Engineer} \quad \textit{video and sound}}{2019.5 - }
\begin{itemize}[parsep=0.2ex]
  \item \textbf{audio/video software development on HiSilicon platform}: \newline
...
\datedsubsection{\textbf{Amaris Consulting (Shanghai) } \quad \textit{Embedded Software Engineer} \quad \textit{Automated testing for embedded system}}{2019.1 - 2019.4}
\begin{itemize}[parsep=0.2ex]
